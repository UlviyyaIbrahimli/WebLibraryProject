        ...
        <div class="bookItems">
            ...
            <c:forEach var="al" items="${author}">
                <ul style="list-style-type: square">
                    <li>
                        <a href="javaScript:authorInfo(${al.author.id})" style="text-decoration: none"><span id="mAuthorId">${al.author.firstName} ${al.author.lastName} ${al.author.fatherName}</span></a>
                    </li>
                </ul>
            </c:forEach>
